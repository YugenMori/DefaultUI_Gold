...
local L = LibStub("AceLocale-3.0"):GetLocale("DefaultUI_Gold")
local GetWoWVersion = ((select(4, GetBuildInfo())))
local f = CreateFrame("Frame", "DefaultUI_Gold_Config", UIParent)
f:SetSize(50, 50)
f:RegisterEvent("PLAYER_LOGIN")
f:SetScript("OnEvent", function(self, event, ...)
  character = UnitName("player").."-"..GetRealmName()
  -- Config/Panel
  if not DefaultUI_Gold_Config then
    local DefaultUI_Gold_Config = {}
  end
  -- Color Init
...
local dialogFrameTexture 		= "Interface\\Addons\\DefaultUI_Gold\\textures\\extra\\dialogFrameTexture"
...
AbyssUISave:SetScript("OnEvent", function(self, event, arg1)
	if (event == "ADDON_LOADED" and arg1 == "DefaultUI_Gold") then
